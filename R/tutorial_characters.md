...
```
    ...
    ## [1] "Involved genes are NRG1 and SST R2"

# Exercise 5.2

In a variable you have the gene name “HCN1” and in another you have its
number of amino acids (890, as numeric!!!). Print out the string “HCN1
protein is 890 aa long”
